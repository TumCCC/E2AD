...
def main_worker(gpu, args, total_list, save_path):
    ...
    elif args.model_name == 'R50':
        model  = R50_R50(bn_pretrain=False)     
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_train_iter', type=int, default=1200,
    ...
    Data Configurations
    '''
    parser.add_argument('--data_dir', type=str, default="../dataset/APTOS/")
    parser.add_argument('-ds', '--dataset', type=str, default='aptos')
