...
parser.add_argument('--data_folder', default='/data/disk2T1/guoj/ISIC2018/original', type=str)
parser.add_argument('--save_folder', default='/data/disk2T1/guoj/ISIC2018', type=str)
