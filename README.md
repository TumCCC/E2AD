...
Also, [UniNet-CVPR2025](https://github.com/pangdatangtt/UniNet) has achieved 100% image-level AUC on APTOS, OCT2017 and ISIC2018 datasets in single-class AD setting. So, our following research direction in medical AD would be the research on small scale datasets, such as few-shot and zero-shot settings, or multi-class setting.
